            ...
            <div className="buttons">
                ...
                <div className="flex-btn">
                    <div>
                        ...
                        <CustomButton theme="start-icon btn-disable-shadow btn-lg"> <i class="material-icons">shopping_cart</i>Default</CustomButton>
                    </div>
                    <div>
                        <p>&#60;Button endIcon=”local_grocery_store” &#47;&#62;
                        </p>
                        <CustomButton theme="end-icon btn-disable-shadow btn-lg">Default <i class="material-icons">shopping_cart</i></CustomButton>
                    </div>
                </div>
                <div className="flex-btn">
                    <div>
